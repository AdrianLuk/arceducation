...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style('slick-theme-styles', get_stylesheet_directory_uri() . '/css/slick-theme.css', array(), $css_version);
		wp_enqueue_style('slick-styles', get_stylesheet_directory_uri() . '/css/slick.css', array(), $css_version);
