...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-107261166-1"></script>
	<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());

	gtag('config', 'UA-107261166-1');
	</script>
...
<div class="hfeed site" id="page">
	...
	<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
		...
		<?php endif; ?>
				...
				<script>jQuery(".menu-item-has-children .dropdown-toggle.nav-link").text("");
    jQuery(".menu-item-has-children .dropdown-toggle.nav-link").addClass("p-0");</script>
			<?php if ( 'container' == $container ) : ?>
			</div><!-- .container -->
			<?php endif; ?>
